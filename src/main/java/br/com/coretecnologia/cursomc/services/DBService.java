...
import br.com.coretecnologia.cursomc.domain.Pagamento;
import br.com.coretecnologia.cursomc.domain.PagamentoComBoleto;
import br.com.coretecnologia.cursomc.domain.PagamentoComCartao;
...
import br.com.coretecnologia.cursomc.domain.enums.Perfil;
...
import br.com.coretecnologia.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cat7.getProdutos().addAll(Arrays.asList(p5, p11));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "ademar.barbosa@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ademar.junior@fazenda.mg.gov.br", "43237433357", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93883221", "34252625"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "28579012", cli2, c2);
